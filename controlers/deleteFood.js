...
export const deleteFoodItem = async (req, res) => {
    try {
        ...
        // Validate that an _id was actually provided
        if (!_id) {
        ...
        // Check if the item existed in the database
        if (!deletedFood) {
        ...
        // We only do this AFTER confirming the database deletion was successful
        ...
        // Catch any server errors (e.g., Mongoose casting errors for malformed IDs)
